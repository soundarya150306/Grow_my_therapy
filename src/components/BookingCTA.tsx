...
export const BookingCTA: React.FC<BookingCTAProps> = ({ onOpenConsultation }) => {
  return (
    <section id="contact" className="py-20 md:py-28 bg-surface-muted/60 relative overflow-hidden border-t border-border">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        
        <div className="relative rounded-3xl bg-primary-dark text-background p-8 sm:p-12 md:p-16 overflow-hidden shadow-elevated">
          
          {/* Subtle botanical glow background */}
          <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-primary-light/40 rounded-full blur-3xl pointer-events-none" />
          <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-secondary/15 rounded-full blur-3xl pointer-events-none" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center relative z-10">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-primary-light/60 border border-primary-light text-xs font-semibold text-secondary-light uppercase tracking-wider">
              ...
              <div className="pt-2 flex flex-col sm:flex-row items-stretch sm:items-center gap-4">
                <button
                  ...
                  className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-full bg-secondary hover:bg-secondary/90 text-primary-dark font-semibold text-sm transition-all shadow-elevated active:scale-[0.98] group"
                >
            ...
            {/* Right Card: Quick Location & Contact Summary */}
            <div className="lg:col-span-5">
              <div className="p-6 sm:p-7 rounded-2xl bg-surface/10 backdrop-blur-md border border-surface/15 space-y-5 text-sm">
